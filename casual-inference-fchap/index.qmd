...
## [Perchè]{.double-underline} l'inferenza causale?

**L'inferenza causale** è fondamentale perché ci permette di comprendere le relazioni tra cause ed effetti nei fenomeni che osserviamo. A differenza dell'analisi della semplice associazione tra variabili, *l'inferenza causale* mira a stabilire relazioni causali, ovvero a identificare l'effetto di una variabile (il [trattamento]{.highlight}) sulla variabile di interesse ([l'outcome]{.highlight}), tenendo conto di tutte le possibili *covariate*.
...
L'obiettivo è stimare l'effetto medio del trattamento (in inglese ATE, [Average treatment effect]{.highlight}):
...
-   La popolazione trattata(o di trattamento) ,$Y_i(1)$ , risulta avere un età più alta e una visione politica più di [*destra/conservatrice*]{.highlight}

-   Mentre la popolazione non trattata (o di controllo), $Y_i(1)$ , risulta essere più giovane e con una visione politica più di [*sinistra/liberale*]{.highlight}
...
## 2. [Difference in means]{.double-underline}
...
Sotto questa ipotesi, la differenza tra la media degli outcomes nel gruppo di trattamento e la media degli outcomes nel gruppo di controllo fornisce una stima [non distorta]{.highlight} dell'effetto medio del trattamento (ATE).

In contesti osservazionali, invece, sono necessari metodi più avanzati come l'IPW e l'AIPW.

### Stima di $\tau$ in un contesto [sperimentale]{.double-underline}
...
e calcolando la media nel gruppo di [controllo]{.double-underline}
...
## 6. [Elementi di diagnostica]{.double-underline}
